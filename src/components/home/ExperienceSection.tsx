...
export const ExperienceSection: React.FC<ExperienceSectionProps> = ({ experiences, education }) => {
  ...
  return (
    <section id="experience" className="scroll-mt-28 py-20 bg-slate-50/60 border-b border-slate-200/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          {/* Toggle Tabs */}
          <div className="inline-flex p-1 rounded-xl bg-slate-200/80 border border-slate-300/60 self-start md:self-auto">
            <button
        ...
        {activeTab === 'experience' && (
          <div className="space-y-6">
            {experiences.map((exp, index) => (
              <div
                key={exp.id}
                className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-xs hover:border-indigo-200 transition-all"
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-4 border-b border-slate-100">
                  ...
                  <div className="flex sm:flex-col items-start sm:items-end gap-2 text-xs text-slate-500 font-medium">
